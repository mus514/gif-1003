...
TEST_F(UneCirconscription, inscrire)
{
	...
	Electeur electeur1("046 454 286", "Marc-Antoine", "Guay",
		    		Date(5,9,1999),Adresse(1001 , "Myrand", "Toronto", "G1V 7A2", "ON"));

	uneCirconscription.inscrire(electeur1);
 ...
 *     vérifier si la personne est supprimees
 *     Cas invalide: vide
 */
TEST_F(UneCirconscription, desinscrire)
{
	Electeur electeur("046 454 286", "Mustapha", "BOUHSEN",
		    		Date(5,6,1991),Adresse(314 , "Miron", "Quebec", "G1V 7A2", "QC"));
	...
	uneCirconscription.desinscrire("046 454 286");
